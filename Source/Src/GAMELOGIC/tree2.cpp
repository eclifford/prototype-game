...
void CTree2::FindRotationAxis(const CGameObject *obj)
{
...
void CTree2::Collide(const CGameObject *obj)
{
...
void CTree2::Reset(void)
{
   
}

void CTree2::TakeDamage(float damage, CGameObject * guywhohitme)
{
   m_HitPoints -= damage;
