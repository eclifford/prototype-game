...
void CTree3::FindRotationAxis(const CGameObject *obj)
{
...
void CTree3::Collide(const CGameObject *obj)
{
...
void CTree3::Reset(void)
{
   
}

void CTree3::TakeDamage(float damage, CGameObject * guywhohitme)
{
   m_HitPoints -= damage;
